...
public class Interpreter {
    ...
    public static void main(String[] args) {
        ...
        Expression expression5 = new Assign(new MultiExpression(new Identifier("test"),new ReAssign(new Identifier("test"),"test",new Literal(3))),"test",new Literal(4d));
        ...
        System.out.println("exp5: " + expression5.eval());//(test = 5; test * (test = 3; test)) = 5 * 3 = 15
    }
}
